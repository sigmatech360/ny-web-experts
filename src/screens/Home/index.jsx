...
const Home = () => {
  ...
  return (
    <>
      ...
      />
      <DefaultLayout>
        <MainBanner onScrollToServices={scrollToServices} />
        ...
        <section
          className="our-services-sec clipedShaped-sec bg-gradiant"
          ref={servicesRef}
        >
          <div className="container">
              ...
              <div className="col-lg-6">
                <div className="sec-content">
                  ...
                  <p data-aos="fade-up" data-aos-duration="3000">
                    ...
                    beautiful design and a powerful backend for a smooth
                    journey!
                  </p>
                  <div
                    className="row mt-4"
